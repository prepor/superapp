...
script_mod! {
    ...
    /** One file, shown: the shell's own card, and under it the line a
        ...
        the path, the preview — is filled from the instance through
        `card::fill`, which is what lets one card draw a file on a disk and
        a part of a letter without knowing there is a difference. */
