...
fn file_card() -> Scene<Setup> {
    Scene::new("file card", (520.0, 420.0))
        .note("One file: its name, what it is and how big, when it changed, where it lives — and the first of it, where there is text to show.")
        ...
        .about("the prototype draws no pictures: the card alone, and it says so")
