...
//! engine needs (see [`kernel::repl::object`]), backed by a directory. It
//! stands in for R2/S3 so two builds can share one bucket with no cloud
//! credentials:
//!
//! ```sh
//! bucketd --dir /tmp/superapp-bucket --port 9000
//! # this machine:      --bucket http://127.0.0.1:9000
