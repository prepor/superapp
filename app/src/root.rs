            ...
            main_window := Window{
                ...
                body +: {
                    ...
                    stage := mod.widgets.Stage{
                        ...
                        accounts_tpl := mod.widgets.AccountsPanel{}
                        accounts_add_tpl := mod.widgets.AccountsAddPanel{}
                        calendar_timeline_tpl := mod.widgets.CalendarTimelinePanel{}
                        calendar_month_tpl := mod.widgets.CalendarMonthPanel{}
                        calendar_event_tpl := mod.widgets.CalendarEventPanel{}
                        calendar_editor_tpl := mod.widgets.CalendarEditorPanel{}
                        calendar_availability_tpl := mod.widgets.CalendarAvailabilityPanel{}
                        calendar_sources_tpl := mod.widgets.CalendarSourcesPanel{}
                        ...
                        telegram_call_tpl := mod.widgets.TelegramCallPanel{}
