...
because decoding follows its bytes. PDFs have previous/next page controls and
a page count, including documents with pages of different sizes or rotation.
