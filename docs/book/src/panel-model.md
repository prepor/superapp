...
effects 5×6); a request larger than the active grid **clamps to it** — which
is why a phone shows the inbox full-screen with no phone-specific layout
code. Requests are honoured
