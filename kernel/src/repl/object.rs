...
//! and [`super::r2`] talks to Cloudflare R2. ETags identify object versions.
...
pub trait Object: Send + Sync {
    ...
    /// says otherwise ([`super::r2`]). A write still publishes at once — the
...
///
/// Shared by the plain-socket client below and the TLS one in [`super::r2`]:
